...
@register_dataset("rg010")
class RGG010Dataset(MatlabMatrix):
    def __init__(self):
        dataset, filename = "rgg010", "rgg010"
        url = "https://suitesparse-collection-website.herokuapp.com/mat/HB/"
        path = osp.join(osp.dirname(osp.realpath(__file__)), "../..", "data", dataset)
        super(RGG010Dataset, self).__init__(path, filename, url)


#https://suitesparse-collection-website.herokuapp.com/mat/HB/rgg010.mat

#https://suitesparse-collection-website.herokuapp.com/mat/Newman/karate.mat